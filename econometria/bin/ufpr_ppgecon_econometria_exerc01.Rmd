...
stargazer(modelo1, type = "text", report = "vcstp*")
...
stargazer(modelo2, type = "text", report = "vcstp*")
...
stargazer(modelo7, type = "text", report = "vcstp*")
```
...
stargazer(modelo8, modelo7, type = "text", report = "vcstp*")
```
...
stargazer(modelo.b1.a, type = "text", report = "vcstp*", digits = 5)
```
...
stargazer(modelo.b1.b, type = "text", report = "vcstp*", digits = 5)
```

```{r b1b plot, options}
plot(dfb$pibpc1000 ~ dfb$etot)
```
...
stargazer(modelo.b2.a, type = "text", report = "vcstp*", digits = 5)
```

```{r b2a plot, options}
plot(dfb$ln_pibpc ~ dfb$etot)
```
...
stargazer(modelo.b2b.1,modelo.b2b.2, type = "text", report = "vcstp*", digits = 5)
```
...
stargazer(modelob.3b.1,modelob.3b.2, type = "text", report = "vcstp*", digits = 5)
